  ...
  return (
    <section className="w-full">
      ...
      <div>
        ...
        {recentWords.map((wordObject, index) => {
          if (currentTime - wordObject.searchedAt > 86400000 && currentTime - wordObject.searchedAt < 172800000) {
            return (
              <div
                key={`${wordObject.word}-${index}`}
                id="recentContainer"
      ...
      <div>
        ...
        {recentWords.map((wordObject, index) => {
          if (currentTime - wordObject.searchedAt > 172800000 && currentTime - wordObject.searchedAt < 604800000 ) {
            return (
              <div
                key={`${wordObject.word}-${index}`}
                id="recentContainer"
